...
Development version (for developers—contains logs and testing data)
Staging version (for testing before release) X Iam not using it now
Production version (the final version uploaded to the store)
